...
set Library     "hls"
set IPName      "controller"
set Version     "1.0"
set DisplayName "Controller"
set Revision    "1903232158"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 config_V W 0x0 "Data signal of config_V" {{0 2 config_V W 0 "Bit 1 to 0 Data signal of config_V"} {2 30 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 packet2controller_V W 0x0 "Data signal of packet2controller_V" {{0 28 packet2controller_V W 0 "Bit 27 to 0 Data signal of packet2controller_V"} {28 4 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 controller2host_ack R 0x0 "Data signal of controller2host_ack" {{0 1 controller2host_ack R 0 "Bit 0 to 0 Data signal of controller2host_ack"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x24 controller2host_ack_ctrl R 0x0 "Control signal of controller2host_ack" {{0 1 controller2host_ack_ap_vld R 0 "Control signal controller2host_ack_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
